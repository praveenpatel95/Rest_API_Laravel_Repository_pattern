...
abstract class BaseRepository implements RepositoryContract
{
    ...
    public function getById($id, array $columns = ['*'])
    {
        ...
        $query = $this->query->find($id, $columns);
        if (!$query) {
            // generic solution
            $reflection = new ReflectionClass($this->model());
            throw new NotFoundException($reflection->getShortName());
        }
        return $query;
    }
    ...
    function updateOrCreate($where, $data = null)
    {
        $this->unsetClauses();
        ...
        if ($data == null) {
            ...
            foreach ($this->model->getFillable() as $property) {
            ...
            $model = $model->updateOrCreate($where, $data);
        }
        return $model;
    }
